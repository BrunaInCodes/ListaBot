...
def executar_robo(robo):
    print(f"Olá, sou o ListaBot, assistente de atendimento da Lista de Compras. Posso esclarecer dúvidas sobre o funcionamento do sistema e como gerenciar seus itens. Deseja saber alguma coisa?")
    ...
    while True:
        ...
        if confianca >= CONFIANCA_MINIMA:
            ...
            print(f"🤖 Ainda não sei responder esta pergunta. [confiança: {confianca}]")
